...
if __name__ == '__main__':
  ...
  FUENTES_POR_CANAL = {
      ...
      'ESPN': [f'https://tecnotv.club/{TOKEN}/android1.m3u', f'https://tecnotv.club/{TOKEN}/android2.m3u'],
      ...
      'History': [f'https://tecnotv.club/{TOKEN}/lista.m3u', f'https://tecnotv.club/{TOKEN}/android1.m3u', f'https://tecnotv.club/{TOKEN}/android2.m3u'],
